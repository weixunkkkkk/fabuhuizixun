...
function manualEvents_() {
  return [
    ...
    event_('京东 618 正式启动', '科技数码', '2026-05-30T20:00:00+08:00', '线上', 'https://finance.sina.com.cn/tob/2026-05-18/doc-inhyhyqp2925192.shtml', 10, '05月30日 20:00'),
...
function guessCategory_(text) {
  if (/新能源|新车|汽车|智驾|两轮电动车|电动自行车|新国标|摩托|鸿蒙智行|华为车BU|华为乾崑|乾崑|引望|小鹏|理想|蔚来|极氪|比亚迪|问界|智界|享界|尊界|尚界|启境|奕境|华境|五菱|极狐|红旗|北京越野|吉利银河|岚图|一汽悦意|九号|爱玛|雅迪|春风动力/.test(text)) return '新能源汽车';
